// app/ats/analytics/export/route.ts
...
export async function GET(req: NextRequest) {
  ...
  for (const app of applications) {
    ...
    // Basic escaping: wrap all fields in quotes and escape internal quotes
  ...
  const filename = `thinkats-analytics-${tenant.slug ?? tenant.id}-${fromStr ?? ""}-${toStr ?? ""}.csv`;
