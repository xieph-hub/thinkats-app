...
export async function GET() {
  ...
  <job>
    ...
    <company>${escapeXml(job.tenant?.name ?? "")}</company>
    <tenantSlug>${escapeXml(job.tenant?.slug ?? "")}</tenantSlug>
...
<jobs provider="ThinkATS" generatedAt="${escapeXml(
