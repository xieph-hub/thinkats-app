    ...
    <div className="min-h-screen bg-slate-50">
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <div className="mt-4 rounded-2xl bg-gradient-to-r from-[#172965] via-[#172965] to-[#203b99] px-5 py-6 text-white shadow-sm sm:px-7 sm:py-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-sm sm:text-base text-slate-100/90">
                  These roles are representative of the searches we run across
                  product, engineering, people, sales and operations. If you
                  don&apos;t see a perfect fit, still join the talent network —
                  we tag and match profiles to upcoming briefs.
                </p>
              </div>
              <div className="flex flex-col items-start gap-3 text-xs lg:items-end">
                <div className="rounded-xl bg-white/10 px-4 py-3 text-slate-50 ring-1 ring-white/15">
                  ...
                  <p className="mt-1 text-[0.75rem]">
                    No spam. Clear briefs, honest feedback, and only roles that
                    make sense for your experience.
                  </p>
                </div>
                <Link
                  href="/talent-network"
                  className="inline-flex items-center justify-center rounded-lg bg-[#64C247] px-4 py-2 text-xs font-semibold text-[#0b1c3d] shadow-sm hover:bg-[#4ea337]"
                >
          ...
          <div className="grid gap-3 text-xs sm:grid-cols-3 sm:text-sm">
            <div className="rounded-xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-200">
              ...
              <p className="mt-1 text-slate-700">
                Product, Engineering, Data, People, Ops, Sales & CS.
              </p>
            </div>
            <div className="rounded-xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-200">
              <p className="text-[0.7rem] font-semibold uppercase tracking-wide text-slate-500">
            ...
            <div className="rounded-xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-200">
              ...
              <p className="mt-1 text-slate-700">
                Share your profile once. We&apos;ll match you to future searches.
              </p>
            </div>
          </div>
        </section>

        {/* Jobs list – simple, readable cards */}
        <section aria-label="Open roles" className="space-y-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-[0.7rem] text-slate-500 sm:text-xs">
              Titles are anonymised where needed; details shared at screening.
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-col items-start gap-2 sm:items-end">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center rounded-lg bg-[#172965] px-3 py-1.5 text-[0.7rem] font-medium text-white shadow-sm hover:bg-[#0f1c46] sm:text-xs"
                    >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                ...
                your profile, we&apos;ll reach out with context and a clear brief.
              </p>
            </div>
            <Link
              href="/talent-network"
